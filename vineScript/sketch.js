...
function setup() {
  ...
  cnv.mousePressed(function(){cloudsOn = !cloudsOn})
}
...
function doTerrain() {
  ...
  else if (vine_location == 2) { // napa
    doGround(325)
    
    fill('#CCD8D9')
    triangle(200, 325, 450, 250, 800, 325)
  }
  else if (vine_location == 3) { //denali
    doGround(275)
  ...
  else if (vine_location == 4) { //greenland
    doGround(375)
  ...
  else if (vine_location == 5) { //kashmere
    doGround(275)
  ...
  else if (vine_location == 6) { //outback
    doGround(325)
  ...
  else if (vine_location == 7) { //siberia
    doGround(325)
  ...
  else if (vine_location == 8) { //mt everest
    doGround(325)
  ...
  else if (vine_location == 9) { //amazon
    doGround(325)
    doRiver(0, 325)
  ...
  else if (vine_location == 10) { //ohio
    doGround(325)
    
    fill('#95855e')
    triangle(200, 325, 450, mHeight(350), 800, 325)
  }
  else if (vine_location == 11) { //borneo
    doGround(325)
  ...
  else if (vine_location == 12) { //fujian
    doGround(325)
  ...
  else if (vine_location == 13) { //long island
    doGround(325)
  ...
  else if (vine_location == 14) { //champagne
    doGround(325)
...
function doClouds() {
  fill(256, 125)
  let x1s = [cloudX+74, cloudX+135, cloudX+40, cloudX+17, cloudX, cloudX+55, cloudX+145, cloudX+95]
